...
const translations = {
    es: {
        ...
        dress_code_description: "No hemos pensado en un código de vestimenta estricto, más allá de atuendos formales para este tipo de eventos, evitando en la medida de lo posible atuendos casual, zapatillas deportivas, etc, y teniendo en cuenta tendrá lugar una ceremonia religiosa.",
        dress_code_men: "Más allá de eso, la única restricción es que las mujeres no pueden ir de blanco o tonos similares.",
        ...
        gifts_description: "Que vengas a celebrar con nosotros es el regalo más grande de todos. No hemos pensado en nada en particular y fortunadamente tenemos de todo. Lo que sí nos gusta mucho es viajar y en unos días estaremos de luna de miel...",
